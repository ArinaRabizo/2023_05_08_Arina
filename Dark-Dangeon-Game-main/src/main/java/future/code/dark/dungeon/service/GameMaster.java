...
public class GameMaster {
    ...
    public void renderFrame(Graphics graphics) {
        ...
        if (getPlayer().getState() > 0) {
            Image img = new ImageIcon("src/main/resources/assets/victory.jpg").getImage();
            graphics.drawImage(img, 150, 5, null);
        } else if(getPlayer().getState() < 0) {
            Image img = new ImageIcon("src/main/resources/assets/game_over_screen.jpg").getImage();
            graphics.drawImage(img, 150, 5, null);
        }
